...
/**
 * Paginated aggregate Collections information object.
 *
 * This class is used when a Collections of records is paginated, and we'll need
 * to associated with the Collections all the pagination's information.
 *
